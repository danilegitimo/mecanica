      ...
      <main class="col-md-10 ms-sm-auto content p-5">
        <div class="container-fluid">
          ...
          <header class="content-header mb-4" style="display: flex; justify-content: space-between; align-items: center;">
            <div style="width: 100%;">
              <h1>Clientes</h1>
              <p>Todos os clientes cadastrados e disponíveis para consulta no banco de dados.</p>
            </div>
            <div>
          ...
          <div>
            ...
            <table class="default-table">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{ $client->id }}</td>
                  <td>{{ $client->name }}</td>
                  <td>{{ $client->contact ?? '*SEM CONTATO' }}</td>
                  <td>
            ...
            @else
             <p>Não há nenhum cliente no banco de dados. Cadastre um.</p>
            @endif
          </div>
        </div>
      </main>
